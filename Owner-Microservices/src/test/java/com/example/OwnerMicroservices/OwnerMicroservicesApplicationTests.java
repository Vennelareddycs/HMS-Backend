...
class OwnerMicroservicesApplicationTests {
	...
	public  void updatesetrate(){
		SetRates setrates=setRatesRepository.findById(3).get();
	...
	public void deleteSetrate(){
		SetRates setrates=setRatesRepository.findById(4).get();
		setRatesRepository.delete(setrates);

		SetRates setrates1=null;

		Optional<SetRates> optionalSetRates=setRatesRepository.findById(7);
